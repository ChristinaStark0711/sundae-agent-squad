...
2. Copy `squads/video-production/templates/brief.md` to `projects/$0/brief.md`, set `slug: $0`
   and, if given, `company: $1`.
3. Ask the user (one message) for what the template leaves blank: purpose, tone, length,
   ...
   and whether inputs will be dropped into `assets/` or listed as URLs. Fill the brief with their
